...
const ChatList = () => {
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', width: '280px', height: '100%' }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'start', width: '100%', padding: '20px 0', maxHeight: '100%', overflowY: 'hidden' }}>
                <ListItem>
